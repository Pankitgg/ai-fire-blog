  ...
  <div class="ai-hub-container">
    ...
    <nav class="flat-nav">
      <div class="nav-wrapper">
        ...
        <div class="nav-menu">
          <a href="https://studio.ai-nous.com/">智心一梦助手</a>
          <a href="/blog">资讯流</a>
          <a href="https://blog.ai-nous.com/" target="_blank" >
            <!-- class="external-link"> -->
            技术博客
    ...
    <section id="partner" class="section blog-recommend-section">
    ...
    <!-- 图书展览 -->
    <section id="books" class="book-exhibition-section">
      <div class="section-container">
        <div class="section-title">
    ...
    <section class="section tools-section" id="tools">
      <div class="section-container">
        ...
        <div class="flat-grid">
          ...
          <!-- 知识库 -->
          <div class="flat-card secondary-card" @click="router.push('/ai/knowledge')">
            <div class="card-icon">📚</div>
            <div class="card-content">
              <h3>知识图谱</h3>
              <p></p>
              <span class="card-action">构建图谱 &rarr;</span>
            </div>
          </div>
    ...
    <!-- 侧边快捷导航 -->
    <div class="side-quick-nav" :class="{ visible: showSideNav }">
      <div class="nav-btn top-btn" @click="scrollToTop" title="回到顶部">
      ...
      <div class="nav-btn bottom-btn" @click="scrollToBottom" title="回到底部">
...
const handleScroll = () => {
  ...
  showSideNav.value = scrollTop > 300
